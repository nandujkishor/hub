...
class Eventsmixin():
    ...
    d1beg = db.Column(db.DateTime)
    d1end = db.Column(db.DateTime)
    d2beg = db.Column(db.DateTime)
    d2end = db.Column(db.DateTime)
    d3beg = db.Column(db.DateTime)
    d3end = db.Column(db.DateTime)
